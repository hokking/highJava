...
public class PhoneBookTest {
	...
	ArrayList<HashMap<String, Phone>> list = new ArrayList<>();
...
//			 map.put(name, p);
		...
		/*
		 * Scanner 메서드 특징
		 * nextLine()이 아닌 메서드 -> next(), nextInt(), nextDouble(); 자료형마다 입력할 수 있는 메서드가 존재
		 * 						: 사이띄기, Tab키, Enter키를 구분문자로 분리해서 분리된 자료만 읽어간다. Enter키의 찌꺼기가 남는다?
