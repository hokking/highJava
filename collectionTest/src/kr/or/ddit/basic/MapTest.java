...
public class MapTest {
	...
	public static void main(String[] args) {
		...
		// 자료 읽기 -> get(key값) : 'key값'과 짝이되는 value값을 반환한다.
		...
		// 방법 1) 모든 key값을 읽어와서 처리하기 -> keySet()메서드 사용
		...
		System.out.println();
		// 방법 3) value값만 읽어와 처리 -> values()메서드를 이용한다
		for(String value : map.values()){ // key값을 알아낼 수는 없다
